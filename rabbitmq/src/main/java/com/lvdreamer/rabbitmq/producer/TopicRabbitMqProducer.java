...
@Component
public abstract class TopicRabbitMqProducer {
    private final static Logger logger = LoggerFactory.getLogger(TopicRabbitMqProducer.class);
    ...
    public void send() {
        ...
        rabbitTemplate.convertAndSend(RabbitConfig.TOPIC_EXCHANGE, "hello.one", LocalTime.now());
    }
